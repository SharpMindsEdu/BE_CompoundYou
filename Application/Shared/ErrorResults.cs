...
public static class ErrorResults
{
    ...
    public const string InvalidDeckCardSelection = "Mindestens eine Karte konnte nicht verwendet werden.";
    public const string InvalidDeckColors = "Mindestens eine Karte entspricht nicht den Farben der Legende.";
