...
public static class RiftboundNamedCardEffectCatalog
{
    ...
    [
        ...
        new GarenCommanderEffect(),
        new GarenMightOfDemaciaEffect(),
        new GarenRuggedEffect(),
        new GearheadEffect(),
        new GemJammerEffect(),
        new GemcraftSeerEffect(),
        new GentlemensDuelEffect(),
        new GetExcitedEffect(),
        new GlascMixologistEffect(),
        new GoldEffect(),
        new GrandStrategemEffect(),
        new GroveOfTheGodWillowEffect(),
        new GuardianAngelEffect(),
        new GuardianOfThePassageEffect(),
        new GuardsEffect(),
        new GuerillaWarfareEffect(),
        new GustEffect(),
        new HallOfLegendsEffect(),
        new HallowedTombEffect(),
        ...
        new JaullFishEffect(),
        new JaxGrandmasterAtArmsEffect(),
        new JaxUnmatchedEffect(),
        new JaxUnrelentingEffect(),
        new JayceManOfProgressEffect(),
        new JeweledColossusEffect(),
        new JinxDemolitionistEffect(),
        new JinxLooseCannonEffect(),
        new JinxRebelEffect(),
        new KadregrinTheInfernalEffect(),
        new KaiSaDaughterOfTheVoidEffect(),
        new KaiSaEvolutionaryEffect(),
        new RiftboundDeclaredCardEffect(
            "kai-sa-survivor",
        ...
        new KarmaChannelerEffect(),
        new KarthusEternalEffect(),
        new KatoTheArmEffect(),
        new KaynUnleashedEffect(),
        new KingsEdictEffect(),
        new KinkouMonkEffect(),
        new KogMawCausticEffect(),
        new KrakenHunterEffect(),
        new LastBreathEffect(),
        new LastRitesEffect(),
        new LastStandEffect(),
        new LaurentBladekeeperEffect(),
        new LaurentDuelistEffect(),
        new LecturingYordleEffect(),
        new LeeSinAsceticEffect(),
        new LeeSinBlindMonkEffect(),
        new LeeSinCenteredEffect(),
        new LegionQuartermasterEffect(),
        new LegionRearguardEffect(),
        new LeonaDeterminedEffect(),
        new LeonaRadiantDawnEffect(),
        new LeonaZealotEffect(),
        new LonelyPoroEffect(),
        new LongSwordEffect(),
        new LoyalPupEffect(),
        new LucianGunslingerEffect(),
        new LucianMercilessEffect(),
        new LucianPurifierEffect(),
        new LuxCrownguardEffect(),
        new LuxIlluminatedEffect(),
        new LuxLadyOfLuminosityEffect(),
        new MachineEvangelEffect(),
        new MaddenedMarauderEffect(),
