...
public sealed class DoransRingEffect : RiftboundNamedCardEffectBase
{
    public override string NameIdentifier => "doran-s-ring";
    public override string TemplateId => "named.doran-s-ring";
    ...
    )
    {
        ...
        {
            runtime.DiscardFromHand(session, player, discarded, "dorans-ring-conquer", card);
        }
