...
public sealed class EdgeOfNightEffect : RiftboundNamedCardEffectBase
{
    public override string NameIdentifier => "edge-of-night";
    public override string TemplateId => "named.edge-of-night";
    ...
    )
    {
        var target = RiftboundEffectUnitTargeting.ResolveTargetUnitFromAction(session, actionId)
            ?? RiftboundEffectUnitTargeting.EnumerateFriendlyUnits(session, player.PlayerIndex)
