...
public sealed class ClothArmorEffect : RiftboundNamedCardEffectBase
{
    public override string NameIdentifier => "cloth-armor";
    public override string TemplateId => "named.cloth-armor";
    ...
    )
    {
        ...
        {
            ["attachedMightBonus"] = "0",
            ["attachedShieldAsDefender"] = "2",
        };
    }
