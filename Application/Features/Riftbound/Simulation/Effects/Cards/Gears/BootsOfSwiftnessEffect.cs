...
public sealed class BootsOfSwiftnessEffect : RiftboundNamedCardEffectBase
{
    public override string NameIdentifier => "boots-of-swiftness";
    public override string TemplateId => "named.boots-of-swiftness";
