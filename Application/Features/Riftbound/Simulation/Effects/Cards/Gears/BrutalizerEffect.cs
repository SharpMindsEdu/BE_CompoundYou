...
public sealed class BrutalizerEffect : RiftboundNamedCardEffectBase
{
    public override string NameIdentifier => "brutalizer";
    public override string TemplateId => "named.brutalizer";
    ...
    )
    {
        ...
        card.EffectData["attachedTurnNumber"] = session.TurnNumber.ToString(CultureInfo.InvariantCulture);
