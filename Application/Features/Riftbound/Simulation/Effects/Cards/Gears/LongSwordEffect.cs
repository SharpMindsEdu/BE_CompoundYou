...
public sealed class LongSwordEffect : RiftboundNamedCardEffectBase
{
    public override string NameIdentifier => "long-sword";
    public override string TemplateId => "named.long-sword";
