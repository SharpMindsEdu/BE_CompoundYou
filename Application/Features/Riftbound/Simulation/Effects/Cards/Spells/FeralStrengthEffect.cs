...
public sealed class FeralStrengthEffect : RiftboundNamedCardEffectBase
{
    public override string NameIdentifier => "feral-strength";
    public override string TemplateId => "named.feral-strength";
