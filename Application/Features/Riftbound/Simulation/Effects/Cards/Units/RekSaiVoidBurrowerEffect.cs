...
public sealed class RekSaiVoidBurrowerEffect : RiftboundNamedCardEffectBase
{
    public override string NameIdentifier => "rek-sai-void-burrower";
    public override string TemplateId => "named.rek-sai-void-burrower";
    ...
    )
    {
        ...
        runtime.AddEffectContext(session, card.Name, player.PlayerIndex, "WhenConquer", metadata);
        return true;
    }
