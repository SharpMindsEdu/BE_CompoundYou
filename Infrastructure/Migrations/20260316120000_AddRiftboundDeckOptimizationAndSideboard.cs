...
{
    public partial class AddRiftboundDeckOptimizationAndSideboard : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_riftbound_deck_optimization_candidate_riftbound_deck_optimization_run_run_id",
                        column: x => x.run_id,
                        principalSchema: "public",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_riftbound_deck_optimization_matchup_riftbound_deck_optimization_run_run_id",
                        column: x => x.run_id,
                        principalSchema: "public",
                        principalTable: "riftbound_deck_optimization_run",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_riftbound_deck_optimization_candidate_run_id_generation_deck_id",
                schema: "public",
                table: "riftbound_deck_optimization_candidate",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_riftbound_deck_optimization_candidate_run_id_generation_legend_id_rank_in_legend",
                schema: "public",
                table: "riftbound_deck_optimization_candidate",
                columns: new[] { "run_id", "generation", "legend_id", "rank_in_legend" });

            migrationBuilder.CreateIndex(
                name: "ix_riftbound_deck_optimization_candidate_run_id_generation_rank_global",
                schema: "public",
                table: "riftbound_deck_optimization_candidate",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_riftbound_deck_optimization_matchup_run_id_generation_deck_a_id_deck_b_id",
                schema: "public",
                table: "riftbound_deck_optimization_matchup",
