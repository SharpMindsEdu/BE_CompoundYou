...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260506130708_AddMinCandlesBetweenBreakoutAndRetest")]
    partial class AddMinCandlesBetweenBreakoutAndRetest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.TradingLiveSettings", b =>
                {
                    ...
                    b.Property<int?>("MinCandlesBetweenBreakoutAndRetest")
                        .HasColumnType("integer")
                        .HasColumnName("min_candles_between_breakout_and_retest");
            ...
            modelBuilder.Entity("Infrastructure.Services.Trading.TradingCalendarDay", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<DateTimeOffset>("CloseTimeUtc")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_trading_calendar_days");

                    b.HasIndex("Date")
                        .IsUnique()
                        .HasDatabaseName("ix_trading_calendar_days_date");

                    b.ToTable("trading_calendar_days", "public");
                });

            modelBuilder.Entity("Infrastructure.Services.Trading.TradingCandleBar", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_trading_candle_bars");

                    b.HasIndex("Symbol", "TimestampUtc")
                        .IsUnique()
                        .HasDatabaseName("ix_trading_candle_bars_symbol_timestamp_utc");

                    b.ToTable("trading_candle_bars", "public");
                });
