...
namespace Infrastructure.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    display_name_search_vector = table
                    ...
                    updated_on = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
                    deleted_on = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
                },
        ...
        {
            migrationBuilder.DropTable(name: "habit_time", schema: "public");

            migrationBuilder.DropTable(name: "habit_trigger", schema: "public");

            migrationBuilder.DropTable(name: "habit", schema: "public");

            migrationBuilder.DropTable(name: "user", schema: "public");
        }
    }
}
