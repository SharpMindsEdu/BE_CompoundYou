...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250725171950_AddHabitTriggerIdToHabitHistory")]
    partial class AddHabitTriggerIdToHabitHistory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.HabitHistory", b =>
                {
                    ...
                    b.Property<long?>("HabitTriggerId")
                        .HasColumnType("bigint")
                        .HasColumnName("habit_trigger_id");
                    ...
                    b.HasIndex("HabitTriggerId")
                        .HasDatabaseName("ix_habit_history_habit_trigger_id");
            ...
            modelBuilder.Entity("Domain.Entities.HabitHistory", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.HabitTrigger", "HabitTrigger")
                        .WithMany()
                        .HasForeignKey("HabitTriggerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("fk_habit_history_habit_trigger_habit_trigger_id");
